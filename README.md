...
Регистрация и аутентификация на основе email пользователя, 
Конвертер из docx или xlsx в pdf работает.
Стили хорошо сделаны.
Есть задание 3.
Можно видеть кто загружал документы и когда.

## Минусы
Когда заходишь на сайт, не перенаправляет на правильный url, надо самому менять url чтобы посмотреть документы,
